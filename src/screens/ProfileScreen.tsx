...
import { View, StyleSheet, ScrollView, Text, TouchableOpacity, Switch, StatusBar } from 'react-native';
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingLeft}>
              ...
              <View style={styles.settingTextContainer}>
                ...
                <Text style={styles.settingValue}>{currentLanguage === 'en' ? 'English' : 'العربية'}</Text>
              </View>
            </View>
            <View style={styles.languageButtons}>
              <TouchableOpacity style={[styles.langButton, currentLanguage === 'en' && styles.langButtonActive]} onPress={() => handleLanguageChange('en')}>
                <Text style={[styles.langButtonText, currentLanguage === 'en' && styles.langButtonTextActive]}>EN</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.langButton, currentLanguage === 'ar' && styles.langButtonActive]} onPress={() => handleLanguageChange('ar')}>
                <Text style={[styles.langButtonText, currentLanguage === 'ar' && styles.langButtonTextActive]}>AR</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View style={styles.settingItem}>
            ...
            <Switch value={darkMode} disabled={true} />
          </View>
        </View>
        <View style={styles.section}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.featureItem}>
            <Ionicons name="checkmark-circle" size={20} color="#e50914" />
            <Text style={styles.featureText}>Ultra HD streaming</Text>
          </View>
          <View style={styles.featureItem}>
            <Ionicons name="checkmark-circle" size={20} color="#e50914" />
...
const styles = StyleSheet.create({
  ...
  profileHeader: { alignItems: 'center', paddingVertical: 24, borderBottomWidth: 1, borderBottomColor: '#333' },
  avatarContainer: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#1a1a2e', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#e50914' },
  profileName: { fontSize: 20, fontWeight: '700', color: '#fff', marginTop: 12 },
  profileEmail: { fontSize: 14, color: '#999', marginTop: 4 },
  section: { paddingHorizontal: 16, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: '#333' },
  sectionTitle: { fontSize: 16, fontWeight: '700', color: '#fff', marginBottom: 12 },
  settingItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#1a1a2e' },
  ...
  langButton: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6, borderWidth: 1, borderColor: '#666' },
  ...
  aboutItem: { paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#1a1a2e' },
